...
@section('container')
    <div class="content container pt-0">
        <div class="card mt-4" style="display: flex; align-items: center; justify-content:center;">
            <div class="card-body">
                <h5 class="card-title" style="text-align: center; font-size: xx-large; margin-bottom: 10px">Square Root</h5>
                ...
                <div class="d-flex justify-content-center flex-column">
                  ...
                  <div class="bg-secondary overflow-auto flex-nowrap">
                    ...
                    <div id="turing_tape3" style="max-width: 64rem" class="rounded-3 d-flex turing-tape overflow-auto flex-nowrap"></div>
                    <div id="turing_tape4" style="max-width: 64rem" class="rounded-3 d-flex turing-tape overflow-auto flex-nowrap"></div>
                    <div id="turing_tape5" style="max-width: 64rem" class="rounded-3 d-flex turing-tape overflow-auto flex-nowrap"></div>
                  </div>
                </div>
              </div>
        ...
        <script src="{{ asset('assets/js/squareRoot.js') }}"></script>
    @endsection
