...
@section('container')
    <div class="content container pt-0">
        <div class="card mt-4" style="display: flex; align-items: center; justify-content:center;">
            <div class="card-body">
                <h5 class="card-title" style="text-align: center; font-size: xx-large; margin-bottom: 10px">Binary Logarithm
                </h5>
    ...
    <script src="{{ asset('assets/js/binaryLogarithm.js') }}"></script>
@endsection
