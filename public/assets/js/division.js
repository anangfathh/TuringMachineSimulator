...
function step() {
    ...
    transition(0, "X", "B", "B", 1, "B", "B", "X", "R", "S", "S");
    transition(0, "Y", "B", "B", 1, "B", "B", "Y", "R", "S", "S");
    transition(0, "1", "B", "B", 5, "B", "B", "B", "R", "S", "S");
    transition(1, "0", "B", "X", 1, "B", "0", "X", "R", "R", "S");
    transition(1, "0", "B", "Y", 1, "B", "0", "Y", "R", "R", "S");
    transition(1, "1", "B", "X", 2, "B", "B", "X", "R", "S", "S");
    transition(1, "1", "B", "Y", 2, "B", "B", "Y", "R", "S", "S");
    transition(2, "X", "B", "X", 3, "B", "B", "X", "R", "L", "R");
    transition(2, "Y", "B", "X", 3, "B", "B", "Y", "R", "L", "R");
    transition(2, "Y", "B", "Y", 3, "B", "B", "X", "R", "L", "R");
    transition(2, "X", "B", "Y", 3, "B", "B", "Y", "R", "L", "R");
    transition(2, "B", "B", "X", 6, "B", "B", "Y", "S", "S", "R");
    transition(2, "B", "B", "Y", 6, "B", "B", "Y", "S", "S", "R");
    transition(3, "0", "0", "B", 3, "0", "B", "B", "R", "L", "S");
    transition(3, "B", "0", "B", 4, "B", "0", "0", "L", "S", "R");
    transition(3, "0", "B", "B", 7, "0", "B", "B", "S", "S", "L");
    transition(3, "B", "B", "B", 7, "B", "B", "0", "S", "S", "R");
    transition(4, "0", "0", "B", 4, "0", "B", "B", "L", "L", "S");
    transition(4, "B", "0", "B", 3, "B", "0", "0", "R", "S", "R");
    transition(4, "0", "B", "B", 7, "0", "B", "B", "S", "S", "L");
    transition(4, "B", "B", "B", 7, "B", "B", "0", "S", "S", "R");
    transition(5, "B", "B", "B", 6, "B", "B", "Y", "S", "S", "R");
    transition(5, "X", "B", "B", 7, "B", "B", "B", "S", "S", "S");
    transition(5, "Y", "B", "B", 7, "B", "B", "B", "S", "S", "S");
    transition(6, "B", "B", "B", 7, "B", "B", "X", "S", "S", "R");
