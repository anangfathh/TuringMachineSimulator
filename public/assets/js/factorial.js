...
function step() {
    ...
    transition(0, "X", "B", "B", 1, "B", "B", "B", "R", "S", "S");
    transition(0, "1", "B", "B", 15, "B", "B", "0", "S", "S", "R");
    transition(1, "0", "B", "B", 1, "0", "B", "0", "R", "S", "R");
    transition(1, "1", "B", "B", 2, "B", "B", "B", "L", "S", "S");
    transition(2, "0", "B", "B", 13, "B", "B", "B", "L", "S", "L");
    transition(3, "0", "0", "B", 3, "0", "0", "0", "S", "L", "R");
    transition(3, "0", "B", "B", 4, "0", "B", "B", "L", "R", "S"); ///fix
    transition(3, "B", "0", "B", 5, "B", "0", "B", "R", "S", "S");
    transition(4, "0", "B", "B", 3, "0", "B", "B", "L", "L", "S");
    transition(4, "0", "0", "B", 4, "0", "0", "0", "S", "R", "R");
    transition(4, "B", "0", "B", 6, "B", "0", "B", "R", "S", "S");
    transition(5, "0", "0", "B", 5, "0", "B", "B", "S", "L", "S");
    transition(5, "0", "B", "B", 7, "B", "B", "B", "R", "S", "L");
    transition(6, "0", "0", "B", 6, "0", "B", "B", "S", "R", "S");
    transition(6, "0", "B", "B", 8, "B", "B", "B", "R", "S", "L");
    transition(7, "0", "B", "0", 7, "0", "0", "B", "S", "R", "L");
    transition(7, "0", "B", "B", 9, "0", "B", "B", "S", "L", "R");
    transition(7, "B", "B", "0", 16, "B", "B", "0", "S", "S", "R"); //itbroke
    transition(8, "0", "B", "0", 8, "0", "0", "B", "S", "L", "L"); //then1
    transition(8, "0", "B", "B", 10, "0", "B", "B", "S", "R", "R");
    transition(8, "B", "B", "0", 16, "B", "B", "0", "S", "S", "R");
    transition(9, "0", "0", "B", 9, "0", "0", "0", "S", "L", "R");
    transition(9, "0", "B", "B", 10, "0", "B", "B", "R", "R", "S");
    transition(9, "B", "0", "B", 11, "B", "0", "B", "L", "S", "S");
    transition(10, "0", "B", "B", 9, "0", "B", "B", "R", "L", "S");
    transition(10, "0", "0", "B", 10, "0", "0", "0", "S", "R", "R");
    transition(10, "B", "0", "B", 12, "B", "0", "B", "L", "S", "S");
    transition(11, "0", "0", "B", 11, "0", "B", "B", "S", "L", "S");
    transition(11, "0", "B", "B", 13, "B", "B", "B", "L", "S", "L");
    transition(12, "0", "0", "B", 12, "0", "B", "B", "S", "R", "S");
    transition(12, "0", "B", "B", 14, "B", "B", "B", "L", "S", "L");
    transition(13, "0", "B", "B", 3, "0", "B", "B", "S", "L", "R");
    transition(13, "0", "B", "0", 13, "0", "0", "B", "S", "R", "L");
    transition(13, "0", "B", "0", 13, "0", "0", "B", "S", "R", "L");
    transition(13, "B", "B", "0", 16, "B", "B", "0", "S", "S", "R");
    transition(14, "0", "B", "B", 4, "0", "B", "B", "S", "R", "R");
    transition(14, "0", "B", "0", 14, "0", "0", "B", "S", "L", "L");
    transition(14, "B", "B", "0", 16, "B", "B", "0", "S", "S", "R");
    transition(15, "B", "B", "B", 16, "B", "B", "B", "S", "S", "R");
...
function transition(
    ...
    if (
        ...
        if (
            ...
            k == turingVal.length - 1 ||
            l == turingVal.length - 1
        ) {
            turingVal.push(new createState("B"));
            turingVal2.push(new createState2("B"));
            turingVal3.push(new createState3("B"));
